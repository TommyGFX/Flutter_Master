...
| 7 | Team & Rechte | In Umsetzung (Rollen-Capability-Mapping-API inkl. tenant-spezifischer Default-Rollenprofile und Org-Management-UI-Matrix ausgeliefert) | Nächster Schritt: Audit-Log-UX (Filter/Export-Flow) im Org-Management vervollständigen |
