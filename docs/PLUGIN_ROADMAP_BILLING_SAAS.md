...
| 7 | Team & Rechte | In Umsetzung (Rollen-Capability-Mapping-API für aktivierte Plugins ergänzt) | Nächster Schritt: Default-Rollenprofile (Admin/Buchhaltung/Vertrieb/Read-only) als tenant-spezifische Seeds und UI-Matrix im Org-Management ausliefern |
