...
CREATE TABLE IF NOT EXISTS billing_payments (
    ...
    payment_kind VARCHAR(32) NOT NULL DEFAULT 'partial',
    amount_paid DECIMAL(18,2) NOT NULL,
    fee_amount DECIMAL(18,2) NOT NULL DEFAULT 0,
    discount_amount DECIMAL(18,2) NOT NULL DEFAULT 0,
    skonto_percent DECIMAL(6,2) NOT NULL DEFAULT 0,
    outstanding_before DECIMAL(18,2) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS billing_dunning_configs (
    ...
    interest_free_days INT NOT NULL DEFAULT 0,
    interest_mode VARCHAR(32) NOT NULL DEFAULT 'flat',
    max_interest_amount DECIMAL(18,2) NOT NULL DEFAULT 0,
